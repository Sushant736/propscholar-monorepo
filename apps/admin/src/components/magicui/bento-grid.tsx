...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div className={cn("flex flex-wrap gap-4 w-full", className)} {...props}>
      {children}
    </div>
  );
};
...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative flex flex-col justify-between overflow-hidden rounded-xl w-full max-w-xs min-w-[250px] flex-1",
      // light styles
