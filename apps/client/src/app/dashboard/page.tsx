...
import { BarChart3, TrendingUp, DollarSign, Target, Calendar, Star } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const recentActivity = [
    { action: "Challenge Passed", platform: "FTMO", amount: "$100K", date: "2 hours ago", type: "success" },
    { action: "Trade Executed", platform: "MyForexFunds", amount: "+$1,247", date: "5 hours ago", type: "profit" },
    { action: "Challenge Started", platform: "The5ers", amount: "$50K", date: "1 day ago", type: "info" },
    { action: "Withdrawal", platform: "TopStep", amount: "$2,500", date: "2 days ago", type: "success" },
  ];
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div className={`w-3 h-3 rounded-full ${
                          ...
                          activity.type === 'profit' ? 'bg-prop-scholar-amber-yellow' :
                      ...
                      <span className={`font-bold ${
                        activity.type === 'profit' ? 'text-green-400' : 'text-prop-scholar-main-text'
                      }`}>
                        {activity.amount}
                      </span>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-prop-scholar-electric-blue/20 rounded-2xl p-6">
                ...
                <div className="flex items-center justify-center gap-1 mb-4">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="h-4 w-4 text-prop-scholar-amber-yellow fill-current" />
                  ))}
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-prop-scholar-electric-blue/20 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <button className="w-full bg-prop-scholar-electric-blue hover:bg-prop-scholar-royal-blue text-white px-4 py-3 rounded-xl font-medium transition-colors">
                    Start New Challenge
                  </button>
                  <button className="w-full bg-white/10 hover:bg-white/20 text-prop-scholar-main-text px-4 py-3 rounded-xl font-medium transition-colors">
                    View All Platforms
                  </button>
                  <button className="w-full bg-white/10 hover:bg-white/20 text-prop-scholar-main-text px-4 py-3 rounded-xl font-medium transition-colors">
                    Trading Journal
