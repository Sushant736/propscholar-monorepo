...
export const PlatformShowcase = ({ className }: { className?: string }) => {
  ...
  return (
    <section 
      ref={targetRef}
      className={cn("relative py-20  bg-gradient-to-b from-slate-900 to-prop-scholar-deep-navy", className)}
    >
      {/* Background Effects */}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 mb-16 text-center">
          ...
          >
            We provide scholarships and funding assistance for all major prop trading platforms. 
            <span className="text-prop-scholar-electric-blue font-semibold"> Choose your platform and let us handle the costs.</span>
          </motion.p>
        </div>
