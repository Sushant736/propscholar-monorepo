...
const CommunityLampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-slate-900 to-prop-scholar-deep-navy w-full z-0 py-24",
        className
      )}>
      <div className='relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0'>
        ...
        <motion.div
          ...
          className='absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-prop-scholar-electric-blue blur-2xl'></motion.div>
        ...
        <motion.div
          ...
          className='absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-prop-scholar-electric-blue'></motion.div>
...
export const DiscordCommunity = ({ className }: { className?: string }) => {
  const communityStats = [
    ...
    },
    {
      ...
      value: "2,500+",
      color: "text-prop-scholar-royal-blue",
    },
    {
      icon: Trophy,
  ...
  const features = [
    {
      ...
      description: "Real-time trading alerts from verified traders",
    },
    {
      icon: TrendingUp,
      title: "Market Analysis",
      description: "Daily market breakdowns and educational content",
    },
    {
      icon: Users,
      title: "Community Support",
      description: "Get help from experienced prop traders",
    },
    {
      icon: Trophy,
      title: "Success Sharing",
      description: "Celebrate wins and learn from funded traders",
    },
  ];
      ...
      <CommunityLampContainer>
        ...
        <motion.div
          ...
          <motion.h1
            ...
            <br />
            <span className='text-prop-scholar-amber-yellow'>
              Trading Community
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            in our exclusive Discord community. Get real-time signals, market
            analysis, and support from funded prop traders.
          </motion.p>
          ...
          <motion.div
            ...
            {communityStats.map((stat, index) => (
              <motion.div
                ...
                <div className='text-sm text-prop-scholar-secondary-text'>
                  {stat.label}
                </div>
              </motion.div>
            ))}
